...
HD_PWD='C:/Users/mason/Desktop/MainProject/MainProject/MainProject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VerilogFile.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VerilogFile.tcl
