...
HD_PWD='C:/Users/mason/Desktop/MainProject/MainProject/MainProject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VerilogFile.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VerilogFile.tcl -notrace
